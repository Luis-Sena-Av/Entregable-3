...
export const Portafolio = ({sectio_activ}) => {
  ...
  return (
    <div className={`portafolio  ${sectio_activ[2].value && "mostrar_sec"}`}>
      ...
      <div className='porta-galery'>
          
          <div>
            <p>Ecomerce</p>
            <div className='project'>
              <a className='im-p' href=""><img src="\imagenes\ecomerce.png" alt="ecomerce" /></a>
          ...
          <div>
            <p>Rick and Morty</p>
            <div className='project'>
              <a className='im-p' href=""><img src="\imagenes\rickandmorty.png" alt="rickandmorty" /></a>
              <div className='project_info'>
          ...
          <div>
            <p>Weather app</p>
            <div className='project'>
              <a className='im-p' href=""><img src="\imagenes\weater.png" alt="weater" /></a>
              <div className='project_info'>
          ...
          <div>
            <p>Users</p>
            <div className='project'>
              <a className='im-p' href=""><img src="\imagenes\crud.png" alt="weater" /></a>
              <div className='project_info'>
          ...
          <div >
            ...
            <div className='project'>
              <a className='im-p' href=""><img src="\imagenes\galletasfortuna.png" alt="weater" /></a>
              <div className='project_info'>
